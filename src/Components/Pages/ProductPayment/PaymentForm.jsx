...
//       } catch (err) {
//         toast.error(err.response?.data?.message || "Failed to fetch product info");
//         setPrice(null);
//         setProductName("");
//       } finally {
//         setLoading(false);
...
//   if (!price) return <p className="text-center text-red-500 py-10">Product not found or unavailable.</p>;
...
//             <p><span className="font-semibold">Customer:</span> {user?.displayName}</p>
//             <p><span className="font-semibold">Email:</span> {user?.email}</p>
//           </div>
//         </div>

//         <div className="w-full">
//           <label className="block mb-1 font-medium text-green-700">Card Number</label>
...
//             <label className="block mb-1 font-medium text-green-700">Expiry Date</label>
//             <div className="border-2 border-green-300 p-3 rounded-md bg-white shadow-sm focus-within:ring-2 focus-within:ring-green-400 transition-all">
//               <CardExpiryElement
//                 options={CARD_ELEMENT_OPTIONS}
...
//         >
//           {paymentSucceeded ? "Payment Successful ✅" : processing ? "Processing..." : "Confirm Payment"}
//         </button>
//       </motion.form>
//     </div>
//   );
