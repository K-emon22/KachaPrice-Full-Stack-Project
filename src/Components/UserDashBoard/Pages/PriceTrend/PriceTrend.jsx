...
//           {/* <div className="bg-green-400 rounded-xl shadow-sm p-4  sticky top-[102px] z-50" >
...
//           {/* --- Redesigned Product Selector --- */}
//           {/* ✅ FIXED: More compact design */}
//           <div className="sticky top-[102px] z-20  bg-white/40 backdrop-blur-xl">
//             <div className="relative bg-white/40 backdrop-blur-xl border border-slate-200/50 rounded-xl shadow-lg p-3">
//               <h3 className="text-base font-bold text-slate-800 mb-2 text-center sm:text-left">
//                 Select Product to Analyze
//               </h3>

//               {/* Wrapper for the fading edge effect */}
...
//                       key={product._id}
//                       onClick={() => handleProductClick(product)}
//                       className={`flex-shrink-0 flex flex-col items-center gap-1.5 w-20 p-2 rounded-lg transition-all duration-200 group ${
//                         selectedProduct?._id === product._id
...
//                         src={product.image}
//                         alt={product.name}
//                         className={`w-14 h-14 object-cover rounded-md transition-transform duration-300 ${
//                           selectedProduct?._id === product._id
//                             ? "scale-105"
          ...
          <div className="sticky top-[102px] z-20 mb-10 lg:mb-5">
            <div className="relative bg-white/40 backdrop-blur-xl border border-slate-200/50  rounded-xl shadow-lg p-3">
              ...
              <div className="relative">
                {/* ✅ The pb-2 class has been removed from this div */}
